...
export const realBean: Vendor = {
  title: "리얼빈",
  url: buildVendorUrl(
    "/realbean/category/cca9273ba86d4707adafaf15872a957a?cp=1"
  ),
  selectors: {
...
export const beanBrothers: Vendor = {
  title: "빈브라더스",
  url: buildVendorUrl(
    "/beanbrothers/category/bde432298242411098a91d5474cf7eb4?cp=1"
  ),
  selectors: {
    cardShapeSelector: buildCardShapeSelector("SQUARE"),
    listSelector: buildSelector(["wOWfwtMC_3", "_3cLKMqI7mI"]),
...
export const hCoffeeRoasters: Vendor = {
  title: "에이치커피로스터스",
  url: buildVendorUrl(
    "/hcoffeeroasters/category/9868ab1333974cfe9a012075dc7f1c03?cp=1"
  ),
  selectors: {
