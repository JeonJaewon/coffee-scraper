...
const CoffeeGridItem = ({ thumbnailSrc, title, price, url, vendor }: CoffeeItem) => (
  <a href={url} target="_blank" className="border border-black rounded shadow-md flex flex-col cursor-pointer">
    ...
    <div className="p-4 bg-gray-100 rounded-lg shadow-md flex-1">
      ...
      <p className="text-lg text-gray-600 mb-1 font-semibold">{formatToKRW(price)}원</p>
      <p className="text-sm text-gray-600 font-semibold text-end">{vendor}</p>
    </div>
  </a>
)
